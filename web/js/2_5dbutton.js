...
//-----------------------------------------
  ...
  function get_css_code()
  {
    ...
    nomal: "" + css_code["class_name"].general + "display: -moz-inline-box;"+ entity["nl"] + entity["indent_1"] + "display: inline-block;"+ entity["nl"] + entity["indent_1"] + "user-select: none;"+ entity["nl"] + entity["indent_1"] + "-moz-user-select: none;"+ entity["nl"] + entity["indent_1"] + "-webkit-user-select: none;"+ entity["nl"] + entity["indent_1"] + "-ms-user-select: none;"+ css_code["snippets"].transition_active + "position: relative;"+ entity["nl"] + entity["indent_1"] + "top: 0px;"+ entity["nl"] + entity["indent_1"] + "cursor: pointer;"+ entity["nl"] + entity["indent_1"] + "text-decoration: none;"+ css_code["snippets"].close +
