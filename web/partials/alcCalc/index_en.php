...
<body id="alccalc">
    ...
    <div class="display-video">
      <div class="video-container">
        <div class="video-wrap">
          <iframe width="1280" height="720" src="http://www.youtube-nocookie.com/embed/5RueEpZMwrE?hd=1&vq=highrez&rel=0&showinfo=0&autohide=1&modestbranding=1&fs=0&cc_load_policy=0&iv_load_policy=1&title=0&byline=0&portrait=0" frameborder="0"></iframe>
        </div>
      </div>
    </div>
  </section>
  <section class="main">
    <section class="caption">
      <p>
        Estimated Time You'll Sober Up
      </p>
      <span class="note">Just enter the drink just as you are about to consume it.</span>
    </section>
    ...
    <section class="using">
      <ul>
        <li class="breath">
          <p class="caption">Breath Aicohol Content</p>
        </li>
        <li class="blood">
          <p class="caption">Blood Alcohol Content</p>
        </li>
        <li class="calorie">
          <p class="caption">Calories Ingested</p>
        </li>
      </ul>
      <ul>
        <li class="hangover">
          <p class="caption">Hangover Forecast</p>
        </li>
        <li class="share">
          <p class="caption">Share Function</p>
        </li>
        <li class="no_ad">
          <p class="caption">Ad-Free, No-Charge</p>
        </li>
      </ul>
    </section>
    ...
    <section class="caution">
      ...
      <p>
        <span>The values displayed by the app are only rough estimates calculated from your weight.</span>
        <span>The accuracy of the app cannot be guaranteed.</span><br/>
        <span>Enjoy drinking in accordance with law.</span>
      </p>
    </section>
  </section>
  <footer>
