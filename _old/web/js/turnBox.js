;(function ($) {
  $.fn.turnBox = function (options) {
    ...
    function get_transform_code(deg, num, adjust) {
      ...
      $.each(prefix, function () {
        transform =
          transform + ' ' + this + 'transform: rotate' + axis + '(' + deg + 'deg) translate3d(' + translate3d + ');\n'
      })
